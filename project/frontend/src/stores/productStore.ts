...
export const useProductStore = defineStore("Product", () => {
  async function getAllProducts(): Promise<Product[]> {
    ...
    try {
      ...
      products = Object.values(data).map((product: any) =>
  ...
  async function getAllByName(field: String, name: String): Promise<Product[]> {
    ...
    try {
      const { data } = await api.get(
        `/product/operation?operation=findByName&field=${field}&name=${name}`
      );
      products = Object.values(data).map((product: any) =>
        mapToProduct(product)
      );
  ...
  async function getAllByPrice(price: number): Promise<Product[]> {
    ...
    try {
      const { data } = await api.get(
        `/product/operation?operation=findByPrice&price=${price}`
      );
      products = Object.values(data).map((product: any) =>
        mapToProduct(product)
      );
  ...
  async function getAllByPriceRange(
    priceInitial: number,
    priceFinal: number
  ): Promise<Product[]> {
    let products: Product[] = [];
    try {
      const { data } = await api.get(
        `/product/operation?operation=findByPriceRange&priceInitial=${priceInitial}&priceFinal=${priceFinal}`
      );
      products = Object.values(data).map((product: any) =>
        mapToProduct(product)
      );
  ...
  async function getAllByAmount(amount: number): Promise<Product[]> {
    ...
    try {
      const { data } = await api.get(
        `/product/operation?operation=findByAmount&amount=${amount}`
      );
      products = Object.values(data).map((product: any) =>
        mapToProduct(product)
      );
  ...
  async function getAllByAmountRange(
    ...
    try {
      const { data } = await api.get(
        `/product/operation?operation=findByAmountRange&?amountInitial=${amountInitial}&amountFinal=${amountFinal}`
      );
      products = Object.values(data).map((product: any) =>
        mapToProduct(product)
      );
  ...
  async function orderByField(field: String, direction: String) {
    ...
    try {
      const { data } = await api.get(
        `/product/operation?operation=orderBy&field=${field}&direction=${direction}`
      );
      products = Object.values(data).map((product: any) =>
        mapToProduct(product)
      );
